...
export const tierList: TierDeck[] = [
  ...
  // 草系
  { slug: "venusaur", nameZh: "超級妙蛙花", image: "/decks/venusaur.png" },
  ...
  // 水系
  { slug: "abomasnow", nameZh: "超級暴雪王", image: "/decks/abomasnow.png" },
  ...
  { slug: "lopunny", nameZh: "超級長耳兔", image: "/decks/lopunny.png" },
  { slug: "mega-kangaskhan", nameZh: "超級袋獸", image: "/decks/mega-kangaskhan.png" },
  // 鋼系
  { slug: "archaludon", nameZh: "鋁鋼橋龍", image: "/decks/archaludon.png" },
  { slug: "dragon-diglett", nameZh: "超級龍頭地鼠", image: "/decks/dragon-diglett.jpg" },
