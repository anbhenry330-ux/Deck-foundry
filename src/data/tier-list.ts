...
/** 屬性分組顯示順序。 */
export const DECK_TYPE_ORDER: DeckType[] = [
  "龍系",
  "電系",
  "鬥系",
  "草系",
...
export const tierList: TierDeck[] = [
  ...
  { slug: "bellibolt", nameZh: "電肚蛙", type: "電系", image: "/decks/bellibolt.png" },
  // 鬥系
  { slug: "lucario", nameZh: "超級路卡利歐", type: "鬥系", image: "/decks/lucario.png" },
  ...
  { slug: "mega-metagross", nameZh: "超級巨金怪", type: "鋼系", image: "/decks/mega-metagross.png" },
  { slug: "aegislash", nameZh: "雙劍鞘", type: "鋼系", image: "/decks/aegislash.png" },
  { slug: "zamazenta-trevenant", nameZh: "蒼響朽木妖", type: "鋼系", image: "/decks/zamazenta-trevenant.png" },
  // 火系
