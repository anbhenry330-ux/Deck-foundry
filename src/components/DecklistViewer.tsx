  ...
  return (
    <>
      <div className="relative overflow-hidden rounded-md border border-[#D9CEB4] bg-[#D9CEB4]/10">
        ...
        <div className="absolute left-0 top-0 border-b border-r border-[#D9CEB4] bg-white/90 px-2.5 py-1.5 font-mono text-[9px] uppercase tracking-wider text-[#3C382F]/60 backdrop-blur-sm">
          LOT {lot}
        </div>
        ...
        <button
          ...
          aria-label="放大檢視完整卡表"
          className="absolute right-2 top-2 inline-flex items-center gap-1.5 rounded-md bg-white/90 px-2.5 py-1.5 text-[11px] font-medium text-[#3C382F] shadow-sm backdrop-blur-sm transition-colors hover:bg-white"
        >
